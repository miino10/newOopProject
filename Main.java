...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            dataGenerator.writeToFilesGroundTruth("KFC_groundTruth_data.txt", 250, 350, new int[]{31, 35, 46});
            dataGenerator.writeToFilesGroundTruth("MCDONALDS_groundTruth_data.txt", 200, 250, new int[]{24, 15, 12});
            dataGenerator.writeToFilesGroundTruth("BURGERKING_groundTruth_data.txt", 150, 300, new int[]{20, 9, 27});
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
